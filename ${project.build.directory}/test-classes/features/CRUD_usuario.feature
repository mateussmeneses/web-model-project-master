...
Funcionalidade: CRUD de usuários
  ...
  Cenário: Criar um novo usuário
    ...
    E o usuário preenche o campo "login" com "Juliana Franca"
    E o usuário preenche o campo "nome completo" com "Juliana Franca"
    E o usuário preenche o campo "email" com "juliana.franca@gft.com "
    E o usuário preenche o campo "idade" com "35"
  ...
  Cenário: Consultar um novo usuário
    ...
    Entao  o usuário deveria ver "login" com "Juliana Franca"
    E o usuário deveria ver "nome completo" com "Juliana Franca"
    E o usuário deveria ver "email" com "juliana.franca@gft.com"
    E o usuário deveria ver "idade" com "35"
  ...
  Cenário: Alterar um usuário
    ...
    E o usuário preenche o campo "nome completo" com "Juliana Souza de Franca" na Edição
    E o usuário clicar em salvar na Edição
    E o usuário clicar em voltar
    E o usuário consultar o último usuário cadastrado
    Entao  o usuário deveria ver "login" com "Juliana Franca"
    E o usuário deveria ver "nome completo" com "Juliana Souza de Franca"
    E o usuário deveria ver "email" com "juliana.franca@gft.com"
    E o usuário deveria ver "idade" com "35"
  ...
  Cenário: Deletar um usuário
    ...
    Entao o usuário não deveria ver o registro deletado "login" com "Juliana Franca"
